...
Other open-source projects from the PageIndex ecosystem: [OpenKB](https://github.com/VectifyAI/OpenKB) is an open LLM knowledge base that compiles documents into a structured, interlinked wiki; [ChatIndex](https://github.com/VectifyAI/ChatIndex) brings tree indexing and retrieval to long conversational histories; [ConDB](https://github.com/VectifyAI/ConDB) is a KV-cache native context database for reasoning-based retrieval via tree search; [Pageindex MCP](https://github.com/VectifyAI/pageindex-mcp) is the MCP server for PageIndex.
