...
- **Better Explainability and Traceability**: Retrieval is based on reasoning, making results traceable and interpretable, with page and section references — not opaque, approximate vector search ("vibe retrieval").
