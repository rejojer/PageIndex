...
For a simple, end-to-end **agentic vectorless RAG** example using PageIndex (with OpenAI Agents SDK), see [`examples/openai_agents_demo.py`](examples/openai_agents_demo.py).
